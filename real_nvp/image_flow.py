...
class ImageFlow(pl.LightningModule):
    ...
    def __init__(
            ...
            visualize_samples_shape: tuple[int, int, int, int] | None = None,
        ):
        """
        Inputs:
        ...
        self.visualize_samples_shape = visualize_samples_shape
    ...
    def validation_step(self, batch, batch_idx):
        ...
        if self.visualize_samples_shape is not None and batch_idx == 0:
            samples = self.sample(self.visualize_samples_shape)
